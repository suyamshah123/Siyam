...
const OWNER_ID = "100074722578899"; // তোমার ফেসবুক আইডি এখানে বসাও
  ...
  onStart: async function({ api, event, args }) {
    ...
    if (senderID !== OWNER_ID) {
      return api.sendMessage(
        "এইটা কি তোর বাপের command নাকি রে? 🤬 হুদাই kamla করতে আসছোস! এইটা শুধুমাত্র siyam ভাই চালায়, বুঝছস? 🫡",
        threadID,
        messageID
      );
    }
    ...
    let kamlaList;
    try {
      kamlaList =i JSON.parse(fs.readFileSync(path, "utf-8"));
    } catch {
      kamlaList = [];
    }
